...
IMAGE_NAME is the name of the Docker image containing the webhook; defaults to 'gcr.io/k8s-staging-gmsa-webhook/k8s-gmsa-webhook:latest'
...
main() {
    ...
    local IMAGE_NAME='gcr.io/k8s-staging-gmsa-webhook/k8s-gmsa-webhook:latest'
